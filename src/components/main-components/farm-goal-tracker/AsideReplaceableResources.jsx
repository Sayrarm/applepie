...
function AsideReplaceableResources({ goal, remaining }) {
  ...
  const updateData = () => {
    const heartsandState = JSON.parse(
      localStorage.getItem(KEYS.INVENTORY_HEARTSAND) || "{}",
    );
    const crystalBoxesState = JSON.parse(
      localStorage.getItem(KEYS.INVENTORY_CRYSTAL_BOXES) || "{}",
    );
  ...
  useEffect(() => {
    const handleStorageChange = (e) => {
      if (
        e.key === KEYS.INVENTORY_HEARTSAND ||
        e.key === KEYS.INVENTORY_CRYSTAL_BOXES
      ) {
        updateData();
      }
    };
  ...
  const needsCrystals =
    goal.type === "memory" && // <-- кристаллы только для memory
    remaining.crystals &&
  ...
  const hasRelevantCrystalBox = needsCrystals && crystalBoxExchange?.hasAny;
      ...
      <div className={styles.replaceableItems}>
        ...
        {needsBottles && heartsandExchange.bottles.R > 0 && (
          <div className={styles.replaceableItem}>
            ...
            <img
              src={getImageUrl("../assets/icons/bottle-r.png")}
              alt="Bottle R"
        ...
        {needsBottles && heartsandExchange.bottles.SR > 0 && (
          <div className={styles.replaceableItem}>
            <span className={styles.itemTitle}>Bottle of Wishes</span>
            <img
              src={getImageUrl("../assets/icons/bottle-sr.png")}
              alt="Bottle SR"
              className={styles.smallIcon}
            />
        ...
        {needsBottles && heartsandExchange.bottles.SSR > 0 && (
          <div className={styles.replaceableItem}>
            <span className={styles.itemTitle}>Bottle of Wishes</span>
            <img
              src={getImageUrl("../assets/icons/bottle-ssr.png")}
              alt="Bottle SSR"
              className={styles.smallIcon}
            />
        ...
        {needsCredits && heartsandExchange.credits.total > 0 && (
          <div className={styles.replaceableItem}>
            ...
            <img
              src={getImageUrl("../assets/icons/credits.png")}
              alt="Credits"
              className={styles.smallIcon}
            />
          ...
          {needsCrystals &&
            ...
            crystalBoxExchange.box_n > 0 && (
              <div className={styles.replaceableItem}>
                ...
                <img
                  src={getImageUrl("../assets/icons/crystal-box-n.png")}
                  alt="Box N"
                  className={styles.smallIcon}
                />
          ...
          {needsCrystals &&
            ...
            crystalBoxExchange.box_r > 0 && (
              <div className={styles.replaceableItem}>
                <span className={styles.itemTitle}>Crystal</span>
                <img
                  src={getImageUrl("../assets/icons/crystal-box-r.png")}
                  alt="Box R"
                  className={styles.smallIcon}
                />
          ...
          {needsCrystals &&
            ...
            crystalBoxExchange.box_sr > 0 && (
              <div className={styles.replaceableItem}>
                <span className={styles.itemTitle}>Crystal</span>
                <img
                  src={getImageUrl("../assets/icons/crystal-box-sr.png")}
                  alt="Box SR"
                  className={styles.smallIcon}
                />
        ...
        {needsCrystals && crystalBoxExchange.box_general > 0 && (
          <div className={styles.replaceableItemGeneralBox}>
            <span className={styles.itemTitle}>
              General Box
              <img
                src={getImageUrl("../assets/icons/crystal-box-general.png")}
                alt="Box General"
                className={styles.smallIcon}
              />
            </span>

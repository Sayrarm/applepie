...
const IconLeft = () => (
    <svg className={styles.iconLeft} viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
...
const IconRight = () => (
    <svg className={styles.iconRight} viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path

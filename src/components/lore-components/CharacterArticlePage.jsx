...
function CharacterArticlePage() {
  ...
  const getCharacterCardsForStory = (storyName) => {
    ...
    const characterCardIds = story.memories.filter((memoryId) => {
      const memory = memoriesData.find(
    ...
    return memoriesData
      .filter(
        (m) => characterCardIds.includes(m.id) && m.char === character.char,
      )
      .sort((a, b) => {
          ...
          <div className={styles.commonContent}>
            <div className={styles.content1}>
              ...
              <div className={styles.section}>
                ...
                <div>{renderMainStory(character.mainStory)}</div>
              </div>
            </div>

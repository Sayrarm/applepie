    ...
    return (
      ...
      >
        ...
        <div style={{ marginBottom: 15 }}>
          <span>Main Stat: </span>
          <Checkbox.Group
            options={mainStatOptions.map((stat) => ({
              label: stat,
              value: stat,
            }))}
            value={mainStats}
        ...
        <div style={{ marginBottom: 15 }}>
          <span>Sub Stat: </span>
          <Checkbox.Group
            options={subStatOptions.map((stat) => ({
              label: stat,
              value: stat,
            }))}
            value={subStats}

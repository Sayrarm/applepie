...
<p>This growing profession was a result of the disaster 14 years ago. Its main goal is to eliminate Wanderers and get their Protocores. Hunters typically exhibit physical and mental prowess. Those who are Evolvers sometimes have better combat capabilities. To become a certified Deepspace Hunter, one must take the Hunters Association's licensure exam, obtain a license, and adhere to the Hunter's Code.</p>    
    ...
    },
    {
        ...
        img: "/sp/a2_worldinfo_1_0008.png",
        content: `
...
<p>Developed in-house by the Hunters Association, this next-generation motorcycle features higher speeds, improved environmental adaptability, and enhanced maneuverability.</p>
    ...
    },
    {
        ...
        navigation: "guidance",
        title: "Wanderers",
        img: "/sp/b2_monster_pic_puppet_04.png",
        content: `
...
<p>So far, six types of Stellactrum have been identified: Emerald, Sapphire, Violet, Amber, Ruby, and Pearl. When the Stellactrum used in combat matches the ones on the field, its effects are amplified twofold.</p>
    ...
    },
    {
        ...
        navigation: "guidance",
        title: "UNICORNS",
        img: "/sp/x3_activity_fall_bg.png",
        content: `
...
<p>The Hunters Association assigns a specialized team to each squad, dedicated to the development, optimization, and maintenance of combat equipment. This team provides state-of-the-art technological support to hunters and enhances the combat capabilities and efficiency of the entire squad.</p>
    ...
    },
    {
        ...
        navigation: "guidance",
        title: "No-Hunt Zone",
        img: "/sp/a2_worldinfo_1_0014.png",
        content: `
...
<p>Fourteen years ago, with the opening of the Deepspace Tunnel, countless Wanderers invaded Earth and began attacking humans. Many lives were lost. Among the affected areas, Linkon City suffered the highest number of casualties.</p>
    ...
    },
    {
        ...
        navigation: "message",
        title: "Skyhaven",
        img: "/sp/a2_worldinfo_2_000302.png",
        content: `
...
<p>Reports speak of a mysterious figure known as the "Dawnbreaker" in Linkon City, someone who eliminates Alterum before law enforcement can even respond.</p>
    ...
    },
    {
        ...
        navigation: "message",
        title: "The Arctic",
        img: "/sp/a2_worldinfo_2_0005.png",
        content: `
...
<p>In the northernmost region of the Arctic is a place perpetually covered in snow. Humans rarely travel to it, and energy fluctuations often occur due to its proximity to Earth's magnetic pole. This makes it a suitable location for many research institutions. There was a wide-scale Wanderer attack that resulted in many casualties. Linkon City dispatched several medical teams to participate in the rescue efforts at that time.</p>
    ...
    },
    {
        ...
        navigation: "message",
        title: "EVER Group",
        img: "/sp/a2_worldinfo_2_0002.png",
        content: `
...
<p>Using the most vibrant colors of Deepspace, the galaxy where a-P0159 resides responded to humanity's lifelong vision of the universe. Thus, it was named Philos, a word meaning "love."</p> 
    ...
    },
    {
        ...
        img: "/sp/a2_worldinfo_2_0007.png",
        content: `
...
<p>The Purists argue that, despite their power, Protocores are inherently dangerous and poorly understood. Warning of a potential catastrophe caused by the overdevelopment of Protocores,they advocate returning to Earth's original energy sources as the only viable path to a sustainable future.    </p>
    ...
    },
    {
        ...
        img: "/sp/a2_worldinfo_2_001001.png",
        content: `
...
<p>Mysterious relief fragments depicting a human face were recently discovered on an offshore island near Verona. Early expert analysis shows that these fragments closely resemble the ruins found in 2034 in the distant waters near Linkon City, suggesting they may come from the same civilization.</p>
    ...
    },
    {
        ...
        navigation: "life",
        title: "Linkon City",
        img: "/sp/b2_mainline_chapterbg_02.png",
        content: `
...
<p>A comprehensive monthly publication for Linkon City residents, visitors, research institutions, and cultural organizations. It covers urban life, scientific developments, hazard alerts, cultural events, and policy analysis, making it one of the city's most authoritative, influential, and trusted public information sources.</p>
    ...
    },
    {
        ...
        navigation: "life",
        title: "Azure Square",
        img: "/sp/a2_worldinfo_3_0017.png",
        content: `
<p>A beautiful square in the heart of Linkon City.</p>    
    ...
    },
    {
        ...
        navigation: "life",
        title: "OTTO",
        img: "/sp/a2_worldinfo_3_0018.png",
        content: `
...
<p>A franchise centered around hunters with different Evols. Its main plot is them working together to defeat Wanderers. It is very popular among elementary and middle school students.</p>    
    ...
    },
    {
        ...
        navigation: "life",
        title: "Hat Island",
        img: "/sp/a2_worldinfo_3_0010.png",
        content: `
<p>A small island located near Linkon's coast. The mountains resemble a hat, hence its name. It was once a popular tourist site. Now, it is abandoned, for Wanderers have taken over.</p>   
    ...
    },
    {
        ...
        navigation: "life",
        title: "Whitesand Bay",
        img: "/sp/2D_SeaCoast_D_Sun_Full2.png",
        content: `
<p>Whitesand Bay is along the coast of Linkon City, where under sunlight, its sand shines a faint, silvery-white hue. The area is romantic and serene. It's a popular resort area and art center.</p>    
    ...
    },
    {
        ...
        navigation: "life",
        title: "Akso Hospital",
        img: "/sp/a2_worldinfo_3_0004_new.png",
        content: `
<p>Linkon's municipal hospital, located downtown. A facility focused on medicine, research, and education. Its divisions such as the Division of Cardiac Surgery and Division of General Surgery are widely respected. At the forefront of healthcare, it is a world-renowned medical institute.</p>    
    ...
    },
    {
        ...
        navigation: "life",
        title: "Flux Arts",
        img: "/sp/a2_phone_momentbg_113_01.png",
        content: `
...
<p>Founded in 1749, this auction house gathers rare art pieces, jewelry watches, vintage cars, and fine wines from all over the world. The majority of these items are heirlooms. Contemporary works make a rare appearance.</p>    
    ...
    },
    {
        ...
        navigation: "life",
        title: "Mo Art Studio",
        img: "/sp/2D_RYStudio_D_Sun_Outside1.png",
        content: `
<p>Situated on an island in Whitesand Bay, it is an art gallery and the private art studio of Rafayel, a famous painter. The first floor is the gallery, but it is usually closed to the public. The second floor is Rafayel's home and art studio.</p>    
    ...
    },
    {
        ...
        navigation: "life",
        title: "Twinkle Toys",
        img: "/sp/a2_worldinfo_3_0007.png",
        content: `
<p>Twinkle Toys is a brand inspired by "bringing joy." Its plushie collections are a worldwide hit. It often collabs with popular animes, games, idols, etc. for events and introduces limited-time products.</p>   
    ...
    },
    {
        ...
        navigation: "life",
        title: "Meow's Cafe",
        img: "/sp/a2_worldinfo_3_0013.png",
        content: `
...
<p>The mall also seamlessly integrates fashion and technology, employing the latest shopping guides for all. It provides the most thoughtful environment for every customer.</p>
    ...
    },
    {
        ...
        img: "/sp/a2_worldinfo_3_0002.png",
        content: `
<p>An administrative division in Linkon City. While it's right next to the city center, it's as if time has stopped. The architecture and streets have kept their look from two or three decades ago. It's a place with a very down-to-earth charm, where one can find tranquility.</p>    
    ...
    },
    {
        ...
        navigation: "tale",
        title: "Lemuria",
        img: "/sp/a2_phone_news_img_2012.png",
        content: `
...
<p>In the world of hunters, "Tenebra" often refers to those who broke the Hunter's Code and engaged in illegal activities. They may do things such as Protocore smuggling or endanger the lives of others. Tenebrae often have ties to secret organizations, carrying out covert missions behind the scenes. They are one of the many targets pursued by the Hunters Association.</p>    
    ...
    },
    {
        ...
        navigation: "tale",
        title: "Lumiere",
        img: "/sp/a2_cardmiddle_st_0080.png",
        content: `
<p>In the midst of the 2034 Chronorift Catastrophe, a mysterious hunter emerged, taking down numerous formidable Wanderers and rescuing countless citizens in Linkon City. This enigmatic hunter played a crucial role in resolving the crisis. Their true identity remains shrouded in mystery, and after the catastrophe, they disappeared without a trace. They appeared again in the last two years, with rumors suggesting that they have already transformed into Tenebra.</p>    
    ...
    },
    {
        ...
        navigation: "tale",
        title: "N109 Zone",
        img: "/sp/a2_worldinfo_4_0005.png",
        content: `
...
<p>Tucked away in a small alley, the bar is only accessible to those with an invitation to its secret Hunting Day. Behind the scenes, it is a complex network brimming with intel and secrets unknown to the public.</p>    
    ...
    },
    {
        ...
        navigation: "tale",
        title: "Odd Workshop",
        img: "/sp/a2_worldinfo_4_0007.png",
        content: `
...
<p>An anonymous virtual platform. It's primarily used to publish and sell information as well as commissions. No one knows who created it, but the creator is unfathomably skilled. As a result, the Abyssal Chaos is the most secretive and powerful platform on the dark web.</p>    
    ...
    },
    {
        ...
        navigation: "note",
        title: "Tara",
        img: "/sp/a2_head_avg_npc_taotao_003.png",
        content: `
<p>The first colleague I befriended after becoming a hunter. Young with a cute personality that suits her name. Aside from being in the know on interesting gossip and info, she really likes divination and the occult. Not only is she a true friend, but also a trustworthy teammate.</p>    
    ...
    },
    {
        ...
        navigation: "note",
        title: "Jenna",
        img: "/sp/a2_head_avg_npc_jiangnan_001.png",
        content: `
...
`
    },
    {
        ...
        navigation: "note",
        title: "Nero",
        img: "/sp/a2_head_avg_npc_chenxian_001.png",
        content: `
<p>Nero is a colleague from Data Analysis who suffers from severe social anxiety. His personal space has a circumference of two meters, and no outsiders are allowed inside it. Since Alpha Team's office is rarely crowded, he uses it to find some peace and quiet. That's why we're acquaintances. Whenever issues related to Wanderers are brought up, he becomes a chatterbox.</p>    
    ...
    },
    {
        ...
        navigation: "note",
        title: "Thomas",
        img: "/sp/a2_phone_headicon_role_npc_02.png",
        content: `
...
<p>A famous soprano singer. She looks to be around my age, but is actually Rafayel's aunt. Elegant, clever, and generous, she has many suitors.</p>    
    ...
    },
    {
        ...
        navigation: "note",
        title: "Flux Nexus",
        img: "/sp/a2_worldinfo_5_0010.png",
        content: `
<p>A device resembling a rock sculpture. It's a totem embedded with diamonds. According to Xavier, it can capture Metaflux and even resurrect Wanderers.</p>    
    ...
    },
    {
        ...
        navigation: "note",
        title: "Josephine",
        img: "/sp/a2_worldinfo_5_0002_new.png",
        content: `
<p>When I was little, Grandma took me and Caleb in. She's my closest, dearest family member.</p>    
    ...
    },
    {
        ...
        navigation: "note",
        title: "Greyson",
        img: "/sp/a2_head_avg_npc_guanxuan_003.png",
        content: `
...
<p>Dr. Noah rescued a small white fox from Mt. Eternal. Pie's intelligence is equivalent to that of a nine-year-old child. He has an exceptional appetite and is adept at acting cute to get food.It's a tactic that never fails. His name is Pie because he devoured six meat pies in one sitting when rescued.    </p>
    ...
    },
    {
        ...
        navigation: "note",
        title: "Aether Core",
        img: "/sp/a2_worldinfo_5_001202.png",
        content: `
...
<p>Though originally shattered, it has reassembled, drawn together by some gravitational pull.    </p>
    ...
    },
    {
        ...
        navigation: "note",
        title: "Jeremiah",
        img: "/sp/a2_head_avg_npc_noah_now_001.png",
        content: `
<p>The owner of Philo, a flower shop. He's also Xavier's friend. Aside from selling flowers, he has a lot of "skills" such as creating new identities and manipulating data so I could enter the N109 Zone... Where did Xavier meet such a friend?</p>    
    ...
    },
    {
        ...
        navigation: "note",
        title: "Sylus",
        img: "/sp/a2_cardmiddle_yg_0008.png",
        content: `
<p>The leader of Onychinus is said to have built his empire on illegal Evol weapons and Protocore deals. He's the most influential, dominant figure in the N109 Zone. However, he hasn't been seen for a while.</p>    
    ...
    },
    {
        ...
        navigation: "note",
        title: "Luke & Kieran",
        img: "/sp/a2_worldinfo_5_0016.png",
        content: `
...
<p>They often wear masks that conceal their faces, so it's difficult to tell the two apart. However, upon closer inspection, one can discern the vivacious and unpredictable nature of the older brother, Luke. This contrasts with the comparatively calm and dependable personality of his younger brother, Kieran.    </p>
    ...
    },
    {
        ...
        navigation: "note",
        title: "Mephisto",
        img: "/sp/a2_head_avg_npc_crow_001.png",
        content: `
...
<p>He possesses extensive knowledge about the Aether Core since his previous work involved monitoring it.    </p>
    ...
    },
    {
        ...
        navigation: "note",
        title: "Andrew",
        img: "/sp/a2_head_avg_npc_anzeyu_001.png",
        content: `
...
<p>His Evol is Memory Alteration, but it only affects those with a lower Evol level than his and lasts no longer than 30 minutes.    </p>
    ...
    },
    {
        ...
        navigation: "note",
        title: "Simone",
        img: "/sp/a2_head_avg_npc_zxy_001.png",
        content: `

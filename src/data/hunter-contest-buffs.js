export const hunterContestBuffs = [
  {
    ...
    "teamAStella2Count": 1,
    "teamA": "Oath Amplification: After using the Ardent Oath, DMG dealt by you and Companion increases by 100% for 10s.",

    "teamBStella1": "../assets/icons/ruby.png",
    "teamBStella1Count": 4,
    "teamBStella2": "../assets/icons/amber.png",
    "teamBStella2Count": 1,
    "teamB": "Press On Stacks: After an Active Skill is used, Support Skill damage increases by 35% for 4s. This effect can stack up to 3 times.",
  ...
  },
  {
    ...
    "teamAStella2Count": 1,
    "teamA": "Charged Attack Penetration: When Wanderer is hit by a Charged Attack, it receives increased DMG in a short period of time.",

    "teamBStella1": "../assets/icons/sapphire.png",
    "teamBStella1Count": 4,
    "teamBStella2": "../assets/icons/emerald.png",
    "teamBStella2Count": 1,
    "teamB": "Collaborative Fusion: Enemies hit by Support Skills take 80% more Basic Attack DMG for 5s.",

...
export const protocoreTypes = {
  ...
  beta: {
    ...
    mainStats: [
      ...
      {
        name: "Expedited Energy Boost",
        values: [
          6, 7.2, 8.4, 9.6, 10.8, 12, 13.2, 14.4, 15.6, 16.8, 18, 19.2, 20.4,
          21.6, 22.8, 24,
        ],
      },
      {
    ...
    mainStats: [
      {
        name: "CRIT Rate",
        values: [
          3.7, 4.2, 4.7, 5.2, 5.7, 6.2, 6.7, 7.2, 7.7, 8.2, 8.7, 9.2, 9.7, 10.2,
          10.7, 11.2,
        ],
      },
      {

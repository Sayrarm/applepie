...
This effect can trigger only once per use of Piercing Rain.`,
  ...
  },
  {
    ...
    empoweredSupportSkillFormula: "360 + 480% ATK",
    empoweredSupportSkillStats: {
      base: 360,
      atk: 480,
      hp: 0,
    ...
    resonanceSkillFormula: "852 + 1136% ATK",
    resonanceSkillStats: {
      base: 852,
      atk: 1136,
      hp: 0,
    ...
    ardentOathFormula: "1800 + 2400% ATK",
    ardentOathStats: {
      base: 1800,
      atk: 2400,
      hp: 0,
    ...
    syncSkill: true,
    basicSyncFirstStrike: "113 + 150% ATK ",
    basicSyncFirstStrikeStats: {
      base: 113,
      atk: 150,
      hp: 0,
      def: 0,
    },
    basicSyncSecondStrike: "222 + 297% ATK",
    basicSyncSecondStrikeStats: {
      base: 222,
      atk: 297,
      hp: 0,
      def: 0,
    },
    basicSyncThirdStrike: "235 + 313% ATK",
    basicSyncThirdStrikeStats: {
      base: 235,
      atk: 313,
      hp: 0,
      def: 0,
    },
    basicSyncFourthStrike: "253 + 337% ATK",
    basicSyncFourthStrikeStats: {
      base: 253,
      atk: 337,
      hp: 0,
      def: 0,
    },
    basicSyncChargedAttack: "356 + 475% ATK",
    basicSyncChargedAttackStats: {
      base: 356,
      atk: 475,
      hp: 0,
      def: 0,
    },
    activeSkill_IFormula: "471 + 628% ATK",
    activeSkill_IStats: {
      base: 471,
      atk: 628,
      hp: 0,
    ...
    activeSkill_IIFormula: "488 + 650% ATK",
    activeSkill_IIStats: {
      base: 488,
      atk: 650,
      hp: 0,
    ...
    activeSkill_IIFormula2: "281 + 375% ATK",
    activeSkill_IIStats2: {
      base: 281,
      atk: 375,
      hp: 0,
      def: 0,
    },
    activeSkill_IIIFormula: "632 + 840% ATK",
    activeSkill_IIIStats: {
      base: 632,
      atk: 840,
      hp: 0,
      def: 0,
    },
    activeSkill_IIIFormula2: "505 + 675% ATK",
    activeSkill_IIIStats2: {
      base: 505,
      atk: 675,
      hp: 0,
      def: 0,
    },
    eidolon0: `When [Warflame Cleave]'s landing strike hits an enemy, it additionally calls down [Martial Fall] on up to 2 enemies on the field.
If [Vermilion Visage] still has energy when [Sundering Thrust] is cast, [Vermilion Visage] will be charged.`,
    eidolon1: `[Martial Intent] is fully charged at the start of combat or when [Martial Soul] dissipates.
...
On hit, [Sundering Thrust] gathers enemies within range and calls down another [Martial Fall] on them. These effects trigger only once per skill cast.`,
    eidolon2: `When fighting alongside Vermilion Martial God, enemy Weakness duration is extended by 1s.
Each time you cast an Active Skill empowered by [Martial Intent], [Vermilion Visage]'s DMG increase effect during your next [Martial Soul] activation is increased by 5%, up to 10%.`,
    eidolon3: `The cooldown of [Sundering Thrust] is reduced by 2s. For 1.5s after casting [Sundering Thrust] Rafayel accumulates [Vermilion Flare] over time, and tapping Basic Attack directly performs the third strike of Basic Attack.
...
export const weaponDataShowcaseSpecific = [
  ...
  },
  {
    ...
    activeSkillFormula: "415 + 553% ATK",
    activeSkillStats: {
      base: 415,
      atk: 553,
      hp: 0,
    ...
    activeSkillSecondFormula: "662 + 883% ATK",
    activeSkillSecondStats: {
      base: 662,
      atk: 883,
      hp: 0,

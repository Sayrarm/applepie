...
import { compData, memoriesData } from "@data";
...
function CompanionBattleInfo() {
  ...
  return (
    <section className={styles.container}>
      ...
      <aside className={styles.asideContainer}>
        <nav className={styles.nav}>
          <Fragment>
            ...
            {currentCategory && (
              <span>
                {currentCategory.companionName || currentCategory.weaponName}
              </span>
            )}
          </Fragment>
        </nav>
      ...
      <CompanionArticlePage data={compData} linkField="link" />
    </section>
  );
}
